...
export default function App() {
  ...
  if (isMobile) {
    return (
      <div className="min-h-screen flex flex-col bg-white text-zinc-900 font-sans select-none">
        {/* Mobile standard Hero Header block */}
        <div className="flex flex-col justify-center min-h-[90vh] bg-zinc-50 border-b border-zinc-200 p-6 relative">
          <div className="absolute top-6 left-6 right-6 flex justify-between items-center font-mono text-[9px] text-zinc-400">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            <h1 className="text-[5rem] sm:text-[7.5rem] font-mono font-black tracking-tighter leading-none text-zinc-950">
              PDF-DS
            </h1>
            <span className="text-zinc-500 text-[9px] font-mono tracking-widest uppercase block mt-4 mb-6">
              — Physical-Digital Fusion Design System —
            </span>
            <p className="text-zinc-900 text-xs sm:text-sm leading-relaxed font-sans font-medium px-4 max-w-sm">
              물리적 기계 공학의 완벽한 재료 통일성과 철저하게 조율된 촉각적 통제력을 기반으로 하는 초고정밀 명세 시스템 가이드라인.
            </p>
            <div className="mt-16 text-[9px] font-mono text-zinc-400 flex flex-col items-center gap-1.5 animate-pulse">
              <span>DOWN SCROLL TO BEGIN</span>
              <div className="w-4 h-7 border border-zinc-300 rounded-full flex justify-center p-0.5">
                <div className="w-1 h-2 bg-red-700 rounded-full mt-0.5" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 py-8 sm:p-6 bg-white">
          <div className="mb-6 pb-6 border-b border-zinc-200">
            <span className="font-mono text-[9px] text-zinc-400 font-extrabold uppercase tracking-widest block mb-4">
              CHAPTER SELECTION
            </span>
      ...
      <div className="fixed inset-0 w-full h-full flex flex-col overflow-hidden z-10 pointer-events-none">
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
          ...
          >
            ...
            >
              <div className="flex justify-between items-start font-mono text-[9px] text-zinc-400">
                <div className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-red-700 animate-pulse" />
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center max-w-4xl mx-auto space-y-8 my-auto">
                <div className="relative">
                  ...
                  >
                    <svg viewBox="0 0 200 200" className="w-80 h-80 text-zinc-950 font-mono text-[4px]">
                  ...
                  <h1 className="text-[5rem] sm:text-[9rem] md:text-[12rem] font-mono font-black tracking-tighter leading-none text-zinc-950 relative z-10 select-none">
                    PDF-DS
                  </h1>
                </div>

                <div className="space-y-4 max-w-lg relative z-10">
                  <span className="text-zinc-500 text-[10px] font-mono tracking-widest uppercase block">
                    — Physical-Digital Fusion Design System —
                  </span>
                  <p className="text-zinc-900 text-xs sm:text-sm leading-relaxed font-sans font-medium px-4">
                    물리적 기계 공학의 완벽한 재료 통일성과 철저하게 조율된 촉각적 통제력을 기반으로 하는 초고정밀 명세 시스템 가이드라인.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center gap-5 relative z-10">
                  ...
                  <div className="text-[9px] font-mono text-zinc-400 flex flex-col items-center gap-1.5 mt-2">
                    ...
                    <div className="w-4 h-7 border border-zinc-300 rounded-full flex justify-center p-0.5">
                      <div className="w-1 h-1.5 bg-red-700 rounded-full anim-scroller-dot" />
                    </div>
                  </div>
                </div>
              </div>

              <div className="flex justify-between items-end font-mono text-[9px] text-zinc-400">
            ...
            >
              <div>
                ...
                <button
                  ...
                  className="w-full mb-4 flex items-center justify-between p-2 rounded border border-zinc-200 bg-white hover:bg-zinc-50 transition-all text-[10px] font-mono group"
                  title="랜딩 인트로 화면으로 복귀"
                >
                  <span className="flex items-center gap-1.5 text-zinc-500 group-hover:text-zinc-950 transition-colors">
                    <ChevronLeft className="w-3.5 h-3.5 text-red-700 transition-transform group-hover:-translate-x-0.5" />
                ...
                <div className="mb-4">
                  <span className="font-mono text-[9px] text-red-700 font-extrabold uppercase tracking-widest block mb-0.5">
                    물리-디지털 융합 디자인 가이드라인
                  </span>
                  <h1 className="text-xl font-mono font-black text-zinc-950 tracking-tight leading-none mb-1">
                    PDF-DS System
                  </h1>
                  ...
                  {chapters.map((ch) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between text-left p-1.5 rounded transition-all group ${isSelected ? 'bg-white text-zinc-950 shadow-xs border-l-3 border-red-700 scale-101' : 'text-zinc-650 hover:text-zinc-900 hover:bg-zinc-100/60'}`}
                      >
                        <div className="flex items-center gap-2 overflow-hidden">
                          <span className={`text-[9px] font-mono font-bold w-3.5 h-3.5 flex items-center justify-center rounded-xs ${isSelected ? 'bg-red-700 text-white' : 'bg-zinc-200 text-zinc-500'}`}>
                            {ch.num}
                          </span>
                          <div className="overflow-hidden">
                            <span className="text-xs font-semibold block truncate leading-none mb-0.5">{ch.title}</span>
                            <span className="text-[8px] font-mono text-zinc-400 block truncate">{ch.sub}</span>
                          </div>
                        </div>
                        <ChevronRight className={`w-3 h-3 text-zinc-400 transition-transform ${isSelected ? 'transform translate-x-0.5 text-red-700' : 'opacity-0 group-hover:opacity-100'}`} />
                      </button>
                    );
                  })}
                </nav>
              ...
              <div className="mt-4 pt-3 border-t border-zinc-200 text-[9px] font-mono text-zinc-400 space-y-1">
                <div className="flex justify-between">
                  <span>DESIGN AUTHOR:</span>
                  <span className="text-zinc-805 font-bold">PDF-DS SPEC TEAM</span>
                </div>
                <div className="flex justify-between">
          ...
          {dockProgress > 0.95 && (
            <div 
              ...
              className={`hidden lg:flex w-1 bg-zinc-200 hover:bg-red-700/80 cursor-col-resize justify-center items-center select-none z-30 transition-colors pointer-events-auto ${isResizing ? 'bg-red-700 text-white' : ''}`}
              title="더블클릭시 38% 표준 비율로 리셋"
            >
              <div className={`w-[1px] h-8 ${isResizing ? 'bg-white' : 'bg-zinc-450'} rounded`} />
            </div>
          )}
          ...
          >
            ...
            <div className="border border-zinc-200 bg-zinc-50 rounded-lg p-5 relative overflow-hidden mb-6 pointer-events-auto">
              ...
              <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                <div>
                  <span className="text-[9px] font-mono text-red-700 bg-red-50 py-0.5 px-2 rounded-full border border-red-100 font-bold">
                    PDF-DS OFFICIAL DOCUMENTATION SYSTEM
                  </span>
                  <h2 className="text-xl font-extrabold text-zinc-950 mt-1.5 tracking-tight">
                    {chapters[activeChapter - 1].title}
                  </h2>
                  <div className="flex items-center gap-1.5 font-mono text-[9px] text-zinc-400 mt-0.5">
                ...
                <div className="bg-white border border-zinc-200 rounded p-1.5 px-2 text-right shrink-0">
                  <span className="text-[8px] font-mono text-zinc-400 block pb-0.5">SPEC PROGRESS</span>
                  <div className="flex items-center gap-2">
                    <div className="w-20 h-1 bg-zinc-100 rounded-full overflow-hidden border border-zinc-200">
                      <div className="bg-red-750 h-full transition-all duration-300" style={{ width: `${(activeChapter / 6) * 100}%` }} />
                    </div>
                    <span className="text-[9px] font-mono font-bold text-zinc-900">{Math.round((activeChapter / 6) * 100)}%</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-zinc-200 pt-5 flex items-center justify-between pointer-events-auto pb-4">
              <button
                id="footer-btn-prev"
                disabled={activeChapter === 1}
                onClick={() => handleChapterSwitch(activeChapter - 1)}
                className={`flex items-center gap-1.5 py-1.5 px-3 border text-xs font-mono font-bold rounded transition-colors ${activeChapter === 1 ? 'text-zinc-300 border-zinc-100 cursor-not-allowed bg-zinc-50' : 'text-zinc-700 border-zinc-200 hover:bg-zinc-50'}`}
              >
              ...
              <button
                ...
                disabled={activeChapter === 6}
                onClick={() => handleChapterSwitch(activeChapter + 1)}
                className={`flex items-center gap-1.5 py-1.5 px-3 border text-xs font-mono font-bold rounded transition-colors ${activeChapter === 6 ? 'text-zinc-300 border-zinc-100 cursor-not-allowed bg-zinc-50' : 'text-zinc-700 border-zinc-200 hover:bg-zinc-50 text-red-700 hover:border-red-300'}`}
              >
                다음 (NEXT)
