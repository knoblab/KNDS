      ...
      {activeChapter === 1 && (
        <section id="ch-1" className="scroll-mt-16 animate-fade-in">
          <div className="flex items-center gap-3 mb-4">
            <div className="bg-red-50 text-red-700 p-2 rounded-lg border border-red-150 shrink-0">
      ...
      {activeChapter === 3 && (
        <section id="ch-3" className="scroll-mt-16 animate-fade-in">
          ...
          <div className="prose max-w-none text-zinc-700 leading-relaxed space-y-4">
            ...
            <h3 className="font-bold text-zinc-900 mt-6 pt-4 border-t border-zinc-200">원리 A: 소재의 대비 → 아크로매틱 3색 스케일 (Chassis to Leather)</h3>
            <p>
            ...
            <h3 className="font-bold text-zinc-900 mt-6 pt-4 border-t border-zinc-200">원리 B: 흐릿한 그림자의 배제 → 1px 아웃라인과 물리적 단차 (Seam)</h3>
            <p>
            ...
            <h3 className="font-bold text-zinc-900 mt-6 pt-4 border-t border-zinc-200">원리 C: 조작의 손맛 → 형태 모핑(Shape Morphing) 메커니즘</h3>
            <p>
      ...
      {activeChapter === 4 && (
        <section id="ch-4" className="scroll-mt-16 animate-fade-in">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <span className="font-mono text-xs tracking-widest text-zinc-400 block uppercase">SECTION 04</span>
              <h2 className="font-sans text-xl md:text-2xl font-black text-zinc-950 tracking-tight">
                정밀 타이포그래피 및 다국어 시스템
              </h2>
            </div>
      ...
      {activeChapter === 5 && (
        <section id="ch-5" className="scroll-mt-16 animate-fade-in">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <span className="font-mono text-xs tracking-widest text-zinc-400 block uppercase">SECTION 05</span>
              <h2 className="font-sans text-xl md:text-2xl font-black text-zinc-950 tracking-tight">
      ...
      {activeChapter === 6 && (
        <section id="ch-6" className="scroll-mt-16 animate-fade-in">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <span className="font-mono text-xs tracking-widest text-zinc-400 block uppercase">SECTION 06</span>
              <h2 className="font-sans text-xl md:text-2xl font-black text-zinc-950 tracking-tight">
          ...
          <div className="prose max-w-none text-zinc-700 leading-relaxed space-y-4">
            <div className="overflow-hidden border border-zinc-200 rounded-lg shadow-xs mt-6">
              <table className="min-w-full divide-y divide-zinc-200 text-sm">
                <thead className="bg-zinc-50 border-b border-zinc-200">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-mono font-bold text-zinc-500 uppercase tracking-wider w-1/4 border-r border-zinc-200">구분</th>
                    <th className="px-6 py-3 text-left text-xs font-mono font-bold text-zinc-500 uppercase tracking-wider w-3/8 border-r border-zinc-200">기존 주류 웹 디자인</th>
                    <th className="px-6 py-3 text-left text-xs font-mono font-bold text-zinc-900 uppercase tracking-wider bg-zinc-100">진화된 PDF-DS 디자인 언어</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-zinc-100">
                  <tr className="hover:bg-zinc-50">
                    <td className="px-6 py-4 font-mono font-bold text-zinc-900 border-r border-zinc-200 whitespace-nowrap">미학적 지향</td>
                    <td className="px-6 py-4 text-zinc-500 border-r border-zinc-200">따뜻함, 인공적 친근성, 감성 마케팅 무드</td>
                    <td className="px-6 py-4 font-bold text-zinc-900">차가움, 솔직함, 정교함, 이성적 기능주의</td>
                  </tr>
                  <tr className="hover:bg-zinc-50">
                    <td className="px-6 py-4 font-mono font-bold text-zinc-900 border-r border-zinc-200 whitespace-nowrap">컬러 원칙</td>
                    <td className="px-6 py-4 text-zinc-500 border-r border-zinc-200">크림색 배경과 다채롭고 빈티지한 삼색선</td>
                    <td className="px-6 py-4 text-zinc-900">완전한 아크로매틱 3색 + <strong className="text-red-700">펑셔널 레드 포인트</strong></td>
                  </tr>
                  <tr className="hover:bg-zinc-50">
                    <td className="px-6 py-4 font-mono font-bold text-zinc-900 border-r border-zinc-200 whitespace-nowrap">공간감 형성</td>
                    <td className="px-6 py-4 text-zinc-500 border-r border-zinc-200">평범한 2차원 화면 분할</td>
                    <td className="px-6 py-4 text-zinc-900">1px 미세 경계면과 투명도 조절을 통한 하드웨어 단차감</td>
                  </tr>
                  <tr className="hover:bg-zinc-50">
                    <td className="px-6 py-4 font-mono font-bold text-zinc-900 border-r border-zinc-200 whitespace-nowrap">조작 피드백</td>
                    <td className="px-6 py-4 text-zinc-500 border-r border-zinc-200">단순한 마우스 오버 시 텍스트 컬러 반전</td>
                    <td className="px-6 py-4 text-zinc-900">손끝 감각을 모사하는 <strong>스프링 기반의 형태 모핑</strong></td>
                  </tr>
                </tbody>
              </table>
            </div>

            <p className="mt-8 p-4 bg-zinc-50 border border-zinc-200 rounded text-zinc-800 leading-relaxed">
