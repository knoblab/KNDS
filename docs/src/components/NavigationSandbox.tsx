...
export default function NavigationSandbox() {
  ...
  return (
    <div className="knds-bg-secondary knds-border knds-p-300">
      <h3 className="knds-text-label-16 knds-mb-200">Navigation & Hierarchy (네비게이션 구조)</h3>
      ...
      <div className="knds-flex-col knds-gap-400">

        {/* 1. Sidebar Item */}
        <div className="knds-flex-col knds-gap-100">
          <label className="knds-text-label-14-mono knds-text-muted">1. Sidebar Navigation (사이드바 메뉴)</label>
          <div
            className="knds-p-200 knds-border knds-radius-md"
            style={{
          ...
          <p className="knds-text-copy-13-mono knds-text-muted knds-mt-100">
        ...
        <div className="knds-flex-col knds-gap-100">
          <label className="knds-text-label-14-mono knds-text-muted">2. Contextual Tabs (수평 탭 / 세그멘티드 컨트롤)</label>
          <div
            className="knds-p-200 knds-border knds-radius-md"
            style={{
          ...
          >
            <div className="knds-flex-row" style={{ display: 'inline-flex', backgroundColor: 'var(--color-bg-secondary)', border: '1px solid var(--color-border-default)', borderRadius: '10px', padding: '4px', gap: '4px', width: '100%', overflowX: 'auto' }}>
              ...
              >
                <span className="knds-text-label-14-mono" style={{ fontWeight: activeTab === 'web' ? '700' : '400' }}>Web (CSS Token)</span>
              </button>
              <button
              ...
              >
                <span className="knds-text-label-14-mono" style={{ fontWeight: activeTab === 'android' ? '700' : '400' }}>Android (Kotlin Compose)</span>
              </button>
              <button
              ...
              >
                <span className="knds-text-label-14-mono" style={{ fontWeight: activeTab === 'ios' ? '700' : '400' }}>iOS (SwiftUI Swift)</span>
              </button>
            </div>

            <div className="knds-p-200 knds-mt-200" style={{ borderTop: '1px solid var(--color-border-default)' }}>
              {activeTab === 'web' && (
                <div className="knds-flex-col knds-gap-100 knds-animate-fade-in">
                  <span className="knds-text-label-14-mono knds-text-red">Web Implementation</span>
              ...
              {activeTab === 'android' && (
                <div className="knds-flex-col knds-gap-100 knds-animate-fade-in">
                  <span className="knds-text-label-14-mono knds-text-red">Android Implementation</span>
                  <p className="knds-text-copy-14 knds-text-muted">
              ...
              {activeTab === 'ios' && (
                <div className="knds-flex-col knds-gap-100 knds-animate-fade-in">
                  <span className="knds-text-label-14-mono knds-text-red">iOS Implementation</span>
                  <p className="knds-text-copy-14 knds-text-muted">
