...
<head>
  ...
  <title>KNDS Exported Page</title>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/antigravity/KNDS@main/knds.css" />
</head>
<body>
  <div class="knds-app">
    <main class="knds-main-view" style="width: 100%; height: 100vh;">
${renderHtml(elements)}
    </main>
  </div>
</body>
    ...
    saveAs(blob, "knds-ds-project.zip");
